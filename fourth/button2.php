...
<div id='dash'>
  ...
  $user=$_SESSION['user'];
  $conn=connect();
  $result = mysqli_query($conn,"SELECT  s_id,e_id,med_all,pf,insurace,basic,incentive FROM salary ");
  echo "<center><table border=1><tr><th>s_id</th><th>e_id</th><th>med_all</th><th>pf</th><th>insurance</th><th>basic</th><th>incentive</th></tr>";
